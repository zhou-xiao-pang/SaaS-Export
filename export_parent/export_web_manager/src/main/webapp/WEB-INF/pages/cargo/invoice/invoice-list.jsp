            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" title="新增" onclick='location.href="${ctx}/cargo/invoice/toAdd.do"'><i class="fa fa-file-o"></i> 新建</button>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr>
                        ...
                        <th class="sorting">发票单号</th>
                        <th class="sorting">订单号</th>
                        <th class="sorting">提单号</th>
                        <th class="sorting">条款</th>
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr>
                            ...
                            <td>${o.creatBy}</td>
                            <td>${o.creatDept}</td>
                            <td><fmt:formatDate value="${o.creatDate}" pattern="yyyy-MM-dd"/></td>
                            <td>${o.amount}</td>
                            <td>
