...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/cargo/shipping/edit.do" method="post">
                <div class="row data-type" style="margin: 0px">
                    <input type="hidden" id="shippingId" name="shippingOrderId"  />
                    <div class="col-md-2 title">运输方式</div>
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" ${shpping.shippingType=="SEA海运"?'checked':''} name="shippingType" value="SEA海运">SEA海运</label></div>
                            <div class="radio"><label><input type="radio" ${shpping.shippingType=="AIR空运"?'checked':''} name="shippingType" value="AIR空运">AIR空运</label></div>
                        </div>
                    </div>
        ...
        <div class="box-tools text-center">
            <button type="button" onclick='submit()' class="btn bg-maroon">保存</button>
            <button type="button" class="btn bg-default" onclick="history.back(-1);">返回</button>
        </div>
        <script>
            function submit() {
                var id = $("input[type=radio][class=packingId]:checked").val();
                $("#shippingId").val(id);
                if(id) {
                    $("#editForm").submit();
                }else{Id
                    alert("请勾选一个装箱单,在进行委托管理")
                }
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${page.list}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                <td><input type="radio" class="packingId" name="shippingId" value="${o.packingListId}"/></td>
