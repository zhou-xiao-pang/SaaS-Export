                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="装箱" onclick="document.getElementById('packForm').submit()" ><i class="fa fa-refresh"></i>装箱</button>
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                        <form id="packForm" action="${ctx}/cargo/packing/toPacking.do" method="post">
