...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">企业管理人信息</div>
            <form id="editForm" action="/company/companyRootEdit.do" method="post">
                <input type="hidden" id="id" name="id" value="">
                <input type="hidden" id="companyName" name="companyName" value="">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">企业管理人名称</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="企业管理人名称" name="userName" value="">
                    </div>
                    <div class="col-md-2 title">所在公司</div>
                    <div class="col-md-4 data">
                        <select class="form-control" onchange="document.getElementById('companyName').value=this.options[this.selectedIndex].text" name="companyId">
                            <option value="">请选择</option>
                            <c:forEach items="${companyList}" var="item">
                                <option ${user.companyId == item.id ?'selected':''} value="${item.id}">${item.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            ...
                            <div class="radio"><label><input type="radio" ${user.degree==2?'checked':''} name="degree" value="2">管理所有下属部门</label></div>
