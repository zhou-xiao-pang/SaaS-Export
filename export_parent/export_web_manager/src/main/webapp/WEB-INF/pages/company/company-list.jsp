                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="查询企业管理人" onclick='location.href="/company/companyRootList.do"'><i class="fa fa-file-o"></i> 查询企业管理人</button>
                            <button type="button" class="btn btn-default" title="创建企业管理人" onclick='location.href="/company/toCompanyRootAdd.do"'><i class="fa fa-file-o"></i> 创建企业管理人</button>
...
<%--            <div class="pull-left">--%>
<%--                <div class="form-group form-inline">--%>
<%--                    总共${result.totalPage} 页，共${result.total} 条数据。 每页--%>
...
<%--                <ul class="pagination">--%>
<%--                    <li>--%>
<%--                        <a href="/company/list.do?page=1&size=10" aria-label="Previous">首页</a>--%>
<%--                    </li>--%>
